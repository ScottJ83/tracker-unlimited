...
export default function PokemonRegionsPage() {
  const cards = [
  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">Regional Archives</h1>
        <div className="sw-page-subtitle">Explore Kanto, Johto, Hoenn, Sinnoh, Unova, Kalos, Alola, Galar, Paldea, and future regions.</div>
      </div>
