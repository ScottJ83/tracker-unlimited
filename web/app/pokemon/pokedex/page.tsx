  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">National and Regional Pokédex</h1>
        <div className="sw-page-subtitle">Browse Pokémon by National Dex, region, forms, and future card archive coverage.</div>
      </div>
