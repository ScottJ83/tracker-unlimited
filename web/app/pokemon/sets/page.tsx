  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">Pokémon Sets</h1>
        <div className="sw-page-subtitle">Track Pokémon TCG sets, expansion completion, variants, and master set progress.</div>
      </div>
