...
export default function PokemonAnalyticsPage() {
  const cards = [
  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">Pokémon Analytics</h1>
        <div className="sw-page-subtitle">View future collection value, completion, region progress, rarity spreads, and variant coverage.</div>
      </div>
