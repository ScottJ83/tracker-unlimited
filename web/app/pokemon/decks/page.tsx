...
export default function PokemonDecksPage() {
  const cards = [
  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">Pokémon Decks</h1>
        <div className="sw-page-subtitle">Build and manage Pokémon decks once the Pokémon data layer is connected.</div>
      </div>
