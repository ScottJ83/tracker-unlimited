  ...
  return (
    <main>
      <div className="sw-page-header">
        ...
        <h1 className="sw-page-title">Pokémon Collection</h1>
        <div className="sw-page-subtitle">Manage owned cards, uncollected cards, and wishlist entries from one collection hub.</div>
      </div>
